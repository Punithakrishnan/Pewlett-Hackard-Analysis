...
--creating table fro dept manager
...
--to delect the table we created by using DROP
--DROP TABLE employees CASCADE;

--re executing the block of code above will create another table
--CREATE TABLE employees (code of blok before)
